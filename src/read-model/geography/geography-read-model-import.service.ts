...
export class GeographyReadModelImportService {
  ...
  private mapLocality(releaseId: string, locality: LocalityRecord) {
    ...
    return {
      ...
      districtId: locality.districtId ?? null,
      subdistrictId: locality.subdistrictId ?? null,
      kind: locality.kind,
